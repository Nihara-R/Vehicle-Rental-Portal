...
public class Read_Receptionist {
	public static void main(String[] args) {
		Read_Receptionist obj_read_Value = new Read_Receptionist();
	...
	public List<User> get_values() {
		...
		String sql ="SELECT * FROM vehiclerenteldemo.user where role='receptionist'";

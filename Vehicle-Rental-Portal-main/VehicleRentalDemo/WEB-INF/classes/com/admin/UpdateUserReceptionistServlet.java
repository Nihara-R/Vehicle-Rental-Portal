...
/**
 * Servlet implementation class UpdateUserReceptionistServlet
 */
@WebServlet("/UpdateUserReceptionistServlet")
public class UpdateUserReceptionistServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateUserReceptionistServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
            ...
            if (rowsUpdated > 0) {
                ...
                response.sendRedirect("desplayalluserreceptionist.jsp?success=true");
            } else {

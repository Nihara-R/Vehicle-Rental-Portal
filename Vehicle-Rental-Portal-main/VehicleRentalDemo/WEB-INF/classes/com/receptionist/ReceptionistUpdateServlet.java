...
/**
 * Servlet implementation class ReceptionistUpdateServlet
 */
@WebServlet("/ReceptionistUpdateServlet")
public class ReceptionistUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReceptionistUpdateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            if (rowsUpdated > 0) {
                ...
                response.sendRedirect("receptionistaccount.jsp?success=true");
            } else {

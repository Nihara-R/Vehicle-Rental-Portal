...
body{
background: url("images/pngtree-vintage-blue-car-aesthetic-3d-rendering-and-artwork-image_3844971.jpg");
...
<form name="userForm" action="AdduserServlet" method="post" class="adminsignupform" onsubmit="return validateForm()">

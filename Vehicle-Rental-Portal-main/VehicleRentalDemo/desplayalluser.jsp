...
<style type="text/css">
body{
background: url("images/268466.jpg");
...
<table >
<tr><th><a href="adduser.jsp" class="adduserlink">add</a></th>
...
<th><h1>Users</h1></th>
    ...
    <tr >
        ...
        <td><a href="updateuser.jsp?ID=<%=obj_User.getId() %>>" class="update-link">Update</a></td>
        <td><a href="DeleteUserServlet?ID=<%= obj_User.getId() %>" class="update-link">Delete</a></td>
    </tr>
    <%
    }
    %>

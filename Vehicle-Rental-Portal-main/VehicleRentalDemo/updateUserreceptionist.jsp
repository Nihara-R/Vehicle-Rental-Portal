...
<style>
body{
background: url("images/ec5078afc3856f2da8d95ee3ad38fc81.jpg");
...
%>
<form name="userForm" action="UpdateUserReceptionistServlet" method="post" class="adminsignupform" onsubmit="return validateForm()">

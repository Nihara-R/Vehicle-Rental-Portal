...
<div class="wrapper">
            ...
            <header>
                ...
                <div class="fullpage">
                    ...
                    <form id="form" name="form" action="AddreceptionistServlet" onsubmit="return validateForm()" method="post">
                    ...
                    <div class="inputfields">
                        ...
                        <i class="material-icons visibility" onclick="show()">visibility</i><br>

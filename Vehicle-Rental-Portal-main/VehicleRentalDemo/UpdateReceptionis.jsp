...
body{
background: url("images/36338810501_4c8b60686b_b.jpg");
...
%>
<form name="userForm" action="UpdateReceptionistServlet" method="post" class="adminsignupform" onsubmit="return validateForm()">

...
body{
background: url("images/1000_F_603271472_jV3V2kLCkdXJhTzkKafQSdhsS85A7LIQ.jpg");
...
<form name="userForm" action="Adminsignupservlet" method="post" class="adminsignupform" onsubmit="return validateForm()">
